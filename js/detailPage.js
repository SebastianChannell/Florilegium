...
function renderPropers(propers){return `${entry('Introitus',propers.introit)}${entry('Oratio',propers.collect)}${entry('Lectio',propers.epistle)}${entry('Graduale',propers.gradual)}${entry('Alleluia',propers.alleluia)}${entry('Tractus',propers.tract)}${entry('Evangelium',propers.gospel)}${entry('Offertorium',propers.offertory)}${entry('Secreta',propers.secret)}${entry('Praefatio',propers.preface)}${entry('Communio',propers.communion)}${entry('Postcommunio',propers.postcommunion)}${entry('Commemorationes',propers.commemorations)}`;}
